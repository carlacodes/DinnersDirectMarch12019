...
if (mysqli_num_rows($result) > 0) {
    ...
    echo '<script type="text/javascript"> alert("An account already exists under those user details!") </script>';
    closeDb($connection);
} else {
    ...
    if ($result) {
        ...
        echo '<script type="text/javascript"> alert("Success, your account has been registered!") </script>';
        closeDb($connection);
    } else {
